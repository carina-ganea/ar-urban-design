...
namespace Google.XR.ARCoreExtensions.Samples.PersistentCloudAnchors
{
    ...
    public class ARViewManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// The Interactor used for spawning and selecting objects.
        /// </summary>
        public ARInteractorSpawnTrigger Interactor;
        ...
        /// is waiting for hosting.
        /// </summary>
        public GameObject _toHost = null;
        ...
        public void OnEnable()
        {
            ...
            switch (Controller.Mode)
            {
                case PersistentCloudAnchorsController.ApplicationMode.Ready:
                    ...
                    break;
                case PersistentCloudAnchorsController.ApplicationMode.ARView:
                    InstructionText.text = "Detecting flat surface...";
                    DebugText.text = "ARCore is waiting for objects to be placed";
                    break;
        ...
        public void Update()
        {
            ...
            else if (Controller.Mode == PersistentCloudAnchorsController.ApplicationMode.Hosting)
            {
                ...
                if (_toHost != null && _toHost.GetComponent<ARAnchor>() == null)
                {
                    ...
                    _toHost.AddComponent<ARAnchor>();

                    // Attach map quality indicator to this anchor.
                    var indicatorGO =
                        Instantiate(MapQualityIndicatorPrefab, _toHost.transform);
                    _qualityIndicator = indicatorGO.GetComponent<MapQualityIndicator>();
                    _qualityIndicator.DrawIndicator(PlaneAlignment.HorizontalUp, Controller.MainCamera);
        ...
        private void HostingCloudAnchor()
        {
            ...
            if (_toHost.GetComponent<ARAnchor>() == null)
            {
                return;
            }
            ...
            var promise = Controller.AnchorManager.HostCloudAnchorAsync(_toHost.GetComponent<ARAnchor>(), 1);
