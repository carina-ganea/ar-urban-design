...
using UnityEngine;
    ...
    /// </summary>
    public class InteractorSpawnTrigger : MonoBehaviour
    {
        /// <summary>
        ...
        ConjureObjectSpawner m_ObjectSpawner;

        /// <summary>
        /// The behavior to use to spawn objects.
        /// </summary>
        public ConjureObjectSpawner objectSpawner
        {
            get => m_ObjectSpawner;
...
#else
                m_ObjectSpawner = FindObjectOfType<ConjureObjectSpawner>();
#endif    
